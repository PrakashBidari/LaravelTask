...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
        <div class="container">
            <a class="navbar-brand" href="#"><span class="text-warning">Laravel</span>Task</a>
    ...
    <section id="news" class="about section-padding">
        <div class="container">
            <h1 class="fw-bold fs-3">All News</h1>
            <div class="row mt-4">
                @if ($allNews->count())
                        ...
                        <div class="col-md-6">
                            <div class="card" style="width: 100%;">
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="card-text">{!! Str::limit($news->description, 50)  !!}</p>
    ...
    <section id="blog" class="about section-padding mt-5">
        <div class="container">
            <h1 class="fw-bold fs-3">All Blogs</h1>
            <div class="row mt-4">
                @if ($allNews->count())
                    @foreach ($blogs as $blog)
                        <div class="col-md-6">
                            <div class="card" style="width: 100%;">
                                <img src="{{ Storage::url($blog->image->url . '/' . $blog->image->saved_name) }}"
                                    class="card-img-top" alt="...">
                                <div class="card-body">
